...
const WhyUs = ({ className }: WhyUsProps) => {
  return (
    <section className={`text-[#070C1B] flex flex-col items-center gap-8 md:gap-12 lg:gap-16 xl:gap-24 py-12 md:py-16 lg:py-24 xl:py-36 ${className ?? ""}`}>
      <h2 id="about" className="font-bold text-4xl md:text-5xl lg:text-6xl xl:text-7xl">Why us?</h2>
      <div className="w-full flex flex-col gap-4 xl:gap-8 md:text-[17px] md:font-medium xl:font-semibold lg:text-lg xl:text-xl">
        ...
        <p>
          Every 42 students came with their own experience like in marketing,
          communication, UX/UI, and multiple technologies and programming
          languages.
        </p>
        <p>
